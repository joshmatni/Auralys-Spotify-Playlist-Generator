...
async function refreshInactiveParallelSegmentsImpl(param) {
    ...
    !fetchedSegments.has(refetchPathname)) {
        ...
        const fetchPromise = (0, _fetchserverresponse.fetchServerResponse)(new URL(refetchPathname, location.origin), // refetch from the root of the updated tree, otherwise it will be scoped to the current segment
